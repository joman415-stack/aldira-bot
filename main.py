...
TOKEN = os.getenv("8763108829:AAGyU_7wTKMLGHz8_EYoUbudQ0ITYGXYNDI")
...
def main():
    if not TOKEN:
        logger.error("❌ BOT_TOKEN غير موجود في متغيرات Railway!")
        return
    ...
    app.add_handler(
        MessageHandler(filters.TEXT, analyze_message)
    )
